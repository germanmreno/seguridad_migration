...
export const Footer = () => {
  return (
    <footer className="sticky top-[100vh] bg-[var(--primary-blue)] h-[125px]min-w-[400px] lg:w-[100%] h-auto xl:h-[125px] p-2 flex justify-center border-t-4 border-gray-950 ">
