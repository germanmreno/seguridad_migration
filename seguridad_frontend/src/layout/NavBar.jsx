...
import { BarChart, LogOut, NotebookTabs } from "lucide-react";
...
export const NavBar = ({ handleLogout }) => {
  ...
  return (
    <nav className="navbar navbar-light bg-[#11237c] m-0 min-w-[400px] lg:w-[100%] h-auto xl:h-[125px] p-2 flex justify-center border-b-4 border-gray-950 ">
      <div className="w-[80%] flex flex-col xl:flex-row justify-between items-center">
        <div className="flex xl:ml-11">
          ...
          <img src="/logo_cvm.png" alt="logo cvm" className="h-[90px] ml-4" />
          <div
            className="inline-block h-[90px] xl:hidden  min-h-[1em] w-0.5 self-stretch separator-gradient "></div>
          <img src="/logo_batalla.png" alt="logo cvm" className="h-[90px] mr-11 xl:hidden invert-[1] brightness-0" />
        </div>
        <div className="flex mt-8 xl:mt-0 lg:mr-11 text-center justify-center items-end text-white">
          {/* <span className="text-xl font-bold primary-text text-center mr-6 mb-4">SISTEMA DE MONITEO DE MINERÍA</span> */}
          <div className="flex flex-col lg:flex-row text-center justify-center items-end text-white p-0">
            ...
            >
              ...
              <span className="primary-text">REGISTRO DE VISITAS</span>
            </Button>
            <Button
              variant="transparent"
              className="flex justify-center items-center p-2"
            ...
            >
              ...
              <span className="primary-text">PANEL DE ESTADÍSTICAS</span>
            </Button>
            <Button
              variant="transparent"
              className="flex justify-center items-center p-2"
